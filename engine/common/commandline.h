...
class CommandLine {
  public:
    ...
    bool                baselineSmoke()    const { return smoke;        }
    const std::string&  baselineFixture()  const { return smokeFixture; }
    int                 fpsOverride()      const { return fps;          }

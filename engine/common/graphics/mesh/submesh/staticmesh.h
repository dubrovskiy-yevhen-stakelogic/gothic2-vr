...
class StaticMesh {
  public:
    ...
    StaticMesh(const PackedMesh& data, bool retainIndexedSource=true);
    ...
    // Android bindless indexed pool source; landscape opts out.
    std::vector<uint32_t>            indexedSource;
    MorphAnim                       morph;

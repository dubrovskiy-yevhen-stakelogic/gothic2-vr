...
void SceneGlobals::setViewProject(const Tempest::Matrix4x4& v, const Tempest::Matrix4x4& p,
  ...
  // Billboard axes are camera rotation, independent of asymmetric eye projection.
  uboGlobalCpu.pfxLeft  = Tempest::Vec3::normalize({v.at(0,0), v.at(1,0), v.at(2,0)});
  uboGlobalCpu.pfxTop   = Tempest::Vec3::normalize({v.at(0,1), v.at(1,1), v.at(2,1)});
  uboGlobalCpu.pfxDepth = Tempest::Vec3::normalize({v.at(0,2), v.at(1,2), v.at(2,2)});
  }

  ...
  public:
    ...
    struct Item {
      public:
        ...
        void setVelocity(const Tempest::Vec3& centimetersPerSecond);
    ...
    RayQueryResult rayNpcMelee  (const Tempest::Vec3& from,const Tempest::Vec3& to,const Npc* except,float radius=3.f) const;
    ...
    Item           addDynamicObj(const Tempest::Matrix4x4& pos, const Bounds& bbox, zenkit::MaterialGroup mat, bool vrBounds=false);

...
class Npc final {
  public:
    ...
    void       setRenderVisible(bool visible) { visual.setRenderVisible(visible); }
    ...
    Item*     takeItemVr(Item& i);
    bool      equipVr(size_t item,bool ignoreRequirements=false);
    void      readyFistsVr();
    ...
    bool      shootVr(const Tempest::Vec3& position, const Tempest::Vec3& direction,float power=1.f,float visualScale=1.f);
    ...
    void      commitSpell();
    void      takeDamage(Npc& other, const Bullet* b, int32_t meleeCap=2147483647);
  ...
  private:
    ...
    void      takeDamage(Npc& other, const Bullet* b, const CollideMask bMask, int32_t splId, bool isSpell, int32_t meleeCap=2147483647);

...
void AbstractGraphicsApi::CommandBuffer::drawIndexedIndirect(const Buffer&, Detail::IndexClass,
                                                            const Buffer&, size_t, size_t, size_t) {
  throw std::system_error(Tempest::GraphicsErrc::UnsupportedExtension);
  }

void AbstractGraphicsApi::CommandBuffer::drawIndexedIndirectCount(const Buffer&, Detail::IndexClass,
                                                                 const Buffer&, size_t,
                                                                 const Buffer&, size_t, size_t, size_t) {
  throw std::system_error(Tempest::GraphicsErrc::UnsupportedExtension);
  }

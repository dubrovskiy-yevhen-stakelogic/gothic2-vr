...
class VDevice : public AbstractGraphicsApi::Device {
  ...
  public:
    ...
    VDevice(VkInstance instance, const bool hasDeviceFeatures2, uint32_t instanceApiVersion, VkPhysicalDevice pdevice);
    ~VDevice() override;
    ...
    static void             deviceProps(VkInstance instance, const bool hasDeviceFeatures2, uint32_t instanceApiVersion, VkPhysicalDevice physicalDevice, VkProps& props);
    ...
    PFN_vkCmdDrawIndexedIndirectCountKHR        vkCmdDrawIndexedIndirectCount = nullptr;

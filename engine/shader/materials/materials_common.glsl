...
// Landscape vertices carry the baked sun visibility in the colour alpha (VR,
// vr/vrbakedlight.h); every non-depth landscape stage shares the varying so
// vertex, tessellation and fragment variants agree.
#if (MESH_TYPE==T_LANDSCAPE) && !defined(DEPTH_ONLY)
#define LND_BAKED 1
#endif
#if (defined(VT_COLOR) || defined(LND_BAKED)) && !defined(DEPTH_ONLY)
#define MAT_COLOR 1
#endif

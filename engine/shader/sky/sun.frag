...
layout(location = 1) noperspective in vec2 inPos;
...
void main() {
  // Match the cleared sky depth exactly, including perspective angular sprites.
  // Interpolated far-plane depth can lose equality through rasterizer rounding.
  gl_FragDepth = 1.0;
